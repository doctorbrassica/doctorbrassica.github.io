...
const SCALES = {
    pentatonic: {
        ...
        noteNames: ['C', 'D#', 'F', 'G', 'A#', 'C+', 'D#+']
    },
    persian: {
        name: 'Persian',
        intervals: [0, 1, 4, 5, 6, 8, 11],
        noteNames: ['C', 'Db', 'E', 'F', 'Gb', 'Ab', 'B']
    },
    phrygian: {
        name: 'Phrygian',
        intervals: [0, 1, 3, 5, 7, 8, 10],
        noteNames: ['C', 'Db', 'Eb', 'F', 'G', 'Ab', 'Bb']
    },
    wholeTone: {
        name: 'Whole Tone',
        intervals: [0, 2, 4, 6, 8, 10, 12],
        noteNames: ['C', 'D', 'E', 'F#', 'G#', 'A#', 'C+']
    },
    blues: {
        name: 'Blues',
        intervals: [0, 3, 5, 6, 7, 10, 12],
        noteNames: ['C', 'Eb', 'F', 'Gb', 'G', 'Bb', 'C+']
    },
    hirajoshi: {
        name: 'Hirajoshi',
        intervals: [0, 2, 3, 7, 8, 14, 15],
        noteNames: ['C', 'D', 'Eb', 'G', 'Ab', 'D+', 'Eb+']
    }
};
...
class MoorhenSynth {
    constructor() {
        ...
        this.scaleIntervals = SCALES.pentatonic.intervals;
    ...
    setScale(scaleName) {
        if (SCALES[scaleName]) {
            ...
            this.scaleIntervals = SCALES[scaleName].intervals;
