...
document.addEventListener('DOMContentLoaded', () => {
    ...
    startBtn.addEventListener('click', async () => {
        try {
            ...
            const hint = startOverlay.querySelector('.hint');
            if (hint) {
                hint.textContent = 'Audio failed to initialize. Please refresh and try again.';
    ...
    // Consolidated mouseup handler for both XY pad and pitch wheel
    ...
    // Simple ambient particle visualization - use canvas dimensions
    const particles = [];
